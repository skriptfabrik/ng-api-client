...
// @ts-ignore
import { CreateAccessToken200Response } from '../model/create-access-token200-response';
// @ts-ignore
import { CreateAccessToken400Response } from '../model/create-access-token400-response';
// @ts-ignore
...
export class AuthorizationService {
     ...
     */
    public createAccessToken(requestParameters: CreateAccessTokenRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CreateAccessToken200Response>;
    public createAccessToken(requestParameters: CreateAccessTokenRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CreateAccessToken200Response>>;
    public createAccessToken(requestParameters: CreateAccessTokenRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CreateAccessToken200Response>>;
    public createAccessToken(requestParameters: CreateAccessTokenRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.request<CreateAccessToken200Response>('post', `${this.configuration.basePath}${localVarPath}`,
            {
